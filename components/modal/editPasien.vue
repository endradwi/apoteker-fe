    ...
    >
      ...
      <form @submit.prevent="editProfile" class="space-y-4" v-if="editUser">
        <div class="flex justify-between gap-4">
          <div>
            ...
            <input
              ...
              disabled
              class="border border-gray-300 p-3 rounded-lg w-full bg-gray-50 text-gray-600 cursor-not-allowed"
            />
          </div>
          <div>
            <label class="block font-semibold text-sm text-gray-700 mb-1"
        ...
        <div>
          ...
          <select
            ...
            :disabled="isLoading"
            class="border border-gray-300 p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#C95792] focus:border-transparent transition-all duration-200 disabled:bg-gray-100 cursor-pointer"
          >
            <option
      ...
      <div v-else class="flex items-center justify-center p-8">
        <div class="flex items-center gap-3">
          <div
            class="animate-spin rounded-full h-6 w-6 border-b-2 border-[#C95792]"
          ></div>
